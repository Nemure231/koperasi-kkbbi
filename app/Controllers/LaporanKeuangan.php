...
class LaporanKeuangan extends BaseController{
    ...
    public function cari(){
        ...
        $total_barang_masuk = $this->model_barang_masuk->selectSUM('barang_masuk.total_harga_pokok',
        ...
        $total_barang_keluar = $this->model_detail_transaksi->selectSUM('detail_transaksi.total_harga',
        ...
        $total_pendaftaran = $this->model_pendaftaran->selectSUM('pendaftaran.biaya',
