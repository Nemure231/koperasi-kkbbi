...
<head>
  ...
  <title>KKBBI &mdash; <?php echo esc($title); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'/user/assets1/css/article.css'; ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'/user/assets1/bootstrap-timepicker/css/bootstrap-timepicker.css' ?>">
</head>