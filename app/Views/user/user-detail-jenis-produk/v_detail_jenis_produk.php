      ...
      <div class="col-lg-12 mt-5 mb-3">
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url().'/' ?>">Beranda</a></li>
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url().'/jenis' ?>">Jenis Produk</a></li>
            <?php if($judul): ?>
              <li class="breadcrumb-item active" aria-current="page"><?php echo $judul['nama_jenis_buku']; ?></li>
            <?php else  : ?>
            ...
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image"
                  data-background="<?php echo base_url('admin/assets/buku').'/'. $ju['sampul_buku']; ?>">
                </div>

              </div>
              <div class="article-details">
                <div class="article-title mb-2">
                  <h2><a class="text-dark" href="#"><?php echo $ju['judul_buku']; ?></a></h2>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 align-right">
                      <a class="btn btn-block btn-sm btn-primary"
                        href="<?php echo base_url().'/produk'.'/'. ''.$ju['uri_buku'].'' ?>">
                        Detail
                      </a>
                    </div>
                  </div>
