      ...
      <div class="col-lg-12">
        <div class="row">
          ...
          <?php if($merek): ?>
            ...
            <?php foreach($merek as $gu):?>
          <div class="col-12 col-sm-6 col-md-6 col-lg-3 post">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image"
                  data-background="<?php echo base_url('admin/assets/barang').'/'. $gu['gambar']; ?>">
                </div>

              </div>
              <div class="article-details">
                <div class="article-title mb-2">
                  <h2><a class="text-dark" href="#"><?php echo $gu['nama']; ?></a></h2>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 align-right">
                      <a class="btn btn-block btn-sm btn-primary"
                        href="<?php echo base_url().'/produk'.'/'. ''.$gu['kode'].'' ?>">
                        Lihat
                      </a>
                    </div>
                  </div>
