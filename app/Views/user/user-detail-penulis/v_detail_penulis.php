      ...
      <div class="col-lg-12 mt-5 mb-3">
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url().'/' ?>">Beranda</a></li>
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url().'/penulis' ?>">Penulis</a></li>
            <?php if($judul): ?>
              <li class="breadcrumb-item active" aria-current="page"><?php echo $judul['nama_penulis']; ?></li>
            <?php else  : ?>
