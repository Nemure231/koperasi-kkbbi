      ...
      <div class="col-lg-12 mt-5 mb-3">
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url().'/' ?>">Beranda</a></li>
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url().'/penerbit' ?>">Penyuplai</a></li>
            <?php if($judul): ?>
      ...
      <div class="col-lg-12">
        <div class="row">
          ...
          <?php if($penyuplai): ?>
            ...
            <?php foreach($penyuplai as $pu):?>
          <div class="col-12 col-sm-6 col-md-6 col-lg-3 post">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image"
                  data-background="<?php echo base_url('admin/assets/barang').'/'. $pu['gambar']; ?>">
                </div>

              </div>
              <div class="article-details">
                <div class="article-title mb-2">
                  <h2><a class="text-dark" href="#"><?php echo $pu['nama']; ?></a></h2>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 align-right">
                      <a class="btn btn-block btn-sm btn-primary"
                        href="<?php echo base_url().'/produk'.'/'. ''.$pu['kode'].'' ?>">
                        Lihat
                      </a>
                    </div>
                  </div>
