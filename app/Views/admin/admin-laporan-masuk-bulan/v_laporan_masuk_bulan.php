      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <?php echo form_open(base_url().'/laporan/masuk/bulanan', $form_bulan);    ?>
              <?php echo csrf_field(); ?>
              <div class="row">
                ...
                <div class="col-lg-12">
                      ...
                      <div class="row">
                        ...
                        <tr>
                          ...
                          <td class="text-center" style="border:1px solid black;">
                            <?php echo $qty = $b['jumlah_barang_masuk']; ?></td>
                          ...
                          <td style="border:1px solid black; border-right: 1px solid black; border-left: none;">
                            <?php $total = $b['harga_pokok_pb'] * $b['jumlah_barang_masuk']; echo 'Rp. '. number_format($total, 0,",",".");?>
                          </td>
                  ...
                  <div class="card-body">
                    <div class="empty-state" data-height="400">
                      ...
                      <p class="lead">
                        Kemungkinan tidak ada barang masuk pada bulan dan tahun yang Anda cari. Silakan tekan tombol di
                        bawah untuk me-refresh halaman, dan kembali ke daftar data bulan ini.
                      </p>
