...
<div class="modal fade" data-backdrop="static" id="modalMenu" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
      ...
      <?php $pesan_tambah = $session->getFlashdata('pesan_validasi_tambah_menu');?>
            ...
            <?php
                $class_tambah_nama_menu = ($pesan_tambah['nama_menu'] ?? []) ? 'is-invalid' : '';
                echo form_input([
                  'name' => "nama_menu",
                  'class' => "form-control "."$class_tambah_nama_menu"."",
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              ...
              <?php
                $class_edit_nama_menu = ($pesan_edit['nama_menu'] ?? []) ? 'is-invalid' : '';
                echo form_input([
                  'id' => "edit_nama_menu",
                  'name' => "edit_nama_menu",
                  'class' => "form-control hapus-validasi-border "."$class_edit_nama_menu"."",
