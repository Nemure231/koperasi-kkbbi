          ...
          <?php if($mmenu): ?>
            ...
            <div class="card-header">
              ...
              <div class="invisible">
                ...
                0
                <?php $validasi_tambah = $session->getFlashdata('pesan_validasi_tambah_menu');
                
                if($validasi_tambah){
                  echo $validasi_tambah['nama_menu']; 

                }?>
                </div>
                <div class="validasi_edit">
                0
                <?php $validasi_edit = $session->getFlashdata('pesan_validasi_edit_menu');
                
                if($validasi_edit){
                  echo $validasi_edit['nama_menu']; 
                }?>
...
<!-- Modal -->
<div class="modal fade" data-backdrop="static" id="modalMenu" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
      ...
      <?php echo form_open(base_url().'/pengaturan/menu/tambah', $form_tambah);    ?>
      <?php $pesan_tambah = $session->getFlashdata('pesan_validasi_tambah_menu');?>
				<div class="modal-body">

					<div class="form-group">
            <label>Nama Menu</label>
            <?php echo tambah_input_helper('nama_menu', 'text', $pesan_tambah['nama_menu'] ?? []); ?>
...
<!-- Modal -->
<div class="modal fade" data-backdrop="static" id="modalEditMenu" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
      ...
      <!-- form action adalah tempat di mana fungsinya berasal, misal tambah menu ini berasal dari controler menu di fungsi index -->
      <?php echo form_open(base_url().'/pengaturan/menu/ubah', $form_edit);    ?>
      <?php $old_data = $session->getFlashdata('old_edit_input');?>
      <?php echo edit_input_id_helper('edit_id_menu', 'edit_id_menu', $old_data['id_menu'] ?? '', 'hidden'); ?>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              ...
              <?php echo edit_input_helper('edit_nama_menu', 'edit_nama_menu', 'text', $pesan_edit['nama_menu'] ?? []); ?>
...
<!-- Modal -->
<div class="modal fade" data-backdrop="static" id="modalHapusMenu" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" id="yahaloo">
        ...
        <?php echo form_open(base_url().'/pengaturan/menu/hapus', $form_hapus);    ?>
        <?php echo form_input($hapus_id_menu); ?>
