        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card" >
            ...
            <div class="row">
              ...
              <h3 class="text-center">Laporan Barang Masuk Harian</h3>
              ...
              <div class="row">
                ...
                <?php if($hari):  ?>
                  <div class="table-responsive">
                      <table class="table table-sm" style="width:100%" id="mashar">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <?php $sum=0;?>
                          <?php $sum_qty=0;?>
                          <?php foreach($hari as $hm):?>
                          <tr>

                            <td>
                              <?php echo $hm['nama_pengirim_barang']; ?>
                             
                            </td>
                            <td><?php echo $hm['nama_barang']; ?></td>
                            ...
                            <td>
                              ...
                              <?php 
                                ...
                                echo 'Rp. '. number_format($hm['harga_pokok_pb'], 0,",",".");
                              
                              
                              ?>

                            </td>
                            <td><?php echo $qty = $hm['jumlah_barang_masuk']; ?></td>
                            <td>

                              <?php 
                      
                              
                                echo 'Rp. '. number_format($hm['total_harga_pokok'], 0,",",".");
                              
                              
                              ?>

                            </td>
                            <td><?php echo $hm['jam']; ?></td>

                            <?php $total = $hm['total_harga_pokok']; ?>
                ...
                <div class="card-body">
                  <div class="empty-state" data-height="400">
                    ...
                    <p class="lead">
                    Kemungkinan tidak ada barang masuk pada tanggal yang Anda cari. Silakan tekan tombol di bawah untuk me-refresh halaman, dan kembali ke daftar data tanggal ini.
                    </p>
