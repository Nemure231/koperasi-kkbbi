                ...
                <div class="col-lg-6 mb-3">
                  <div class="alert alert-primary alert-has-icon">
                    ...
                    <div class="alert-body">
                      ...
                      Anda juga dapat melakukan pencarian pada bulan telah lewat menggunakan form
                      pencarian.
                    </div>
                  </div>
              ...
              <div class="row" id="area-1">
                ...
                <div class="col-lg-12">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <h3 class="text-center">Laporan Barang Summary Bulan</h3>
                      ...
                      <h5 class="text-right"><?php  echo  $bulan_ini; ?></h5>
                    </div>
                    <div class="col-2">
                    ...
                    <div class="col-6">
                      <div class="table-responsive">
                        <table class="table table-sm table-bordered">
                          ...
                          <tbody>
                            <?php  $i =1;?>
                            <?php foreach($bulan_masuk as $m):?>
                            <tr>
                              <th class="text-center" style="border: 1px solid black;"scope="row"><?php echo $i; ?></th>

                              <td style="border: 1px solid black;"><?php echo $m['nama_bulan']; ?></td>
