            ...
            <div class="col-lg-12">
              ...
              <?php if($tahun):  ?>
                <div class="table-responsive">
                      <table class="table table-sm" style="width:100%" id="mastah">
                        <thead>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <?php 
                                ...
                                echo 'Rp. '. number_format($th['harga_pokok_pb'], 0,",",".");
                              
                              
                              ?>

                            </td>
                            <td><?php echo $qty = $th['jumlah_barang_masuk']; ?></td>
                            <td>

                              <?php 
                      
                              
                                echo 'Rp. '. number_format($th['total_harga_pokok'], 0,",",".");
                              
                              
                              ?>

                            </td>
                            <td><?php echo $th['tanggal_masuk']; ?></td>
                           <?php $total = $th['total_harga_pokok']; ?>
