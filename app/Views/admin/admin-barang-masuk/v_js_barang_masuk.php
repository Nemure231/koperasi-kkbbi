...
<script type="application/javascript" src="<?php echo base_url().'/admin/assets/js/additional-methods.min.js'; ?>"></script>
<script type="application/javascript" src="<?php echo base_url().'/admin/assets/modules/jquery-ui/jquery-ui.min.js'; ?>"></script>
