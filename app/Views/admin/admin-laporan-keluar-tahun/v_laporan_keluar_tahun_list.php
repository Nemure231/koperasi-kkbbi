                ...
                <div class="col-lg-12">
                  <div class="row">
                    ...
                    <div class="col-8">
                      ...
                      <h5 class="text-right">Tahun <?php date_default_timezone_set("Asia/Jakarta"); echo  date('Y'); ?>
                      </h5>
                    </div>
                    <div class="col-2">
                  ...
                  <div class="row">
                    ...
                    <div class="table-responsive">
                      <table class="table table-sm" style="width:100%" id="keltah">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="text-left"><?php echo $th['tt_kode_transaksi']; ?></div>
                              <?php echo 'Rp. '. number_format($th['tt_total_harga'], 0,",","."); ?>
                            </td>
                            <td><?php echo $th['nama_barang']; ?></td>
                            <td><?php echo $th['nama_pengirim_barang']; ?></td>
