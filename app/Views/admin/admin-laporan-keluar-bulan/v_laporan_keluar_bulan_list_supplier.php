                ...
                <img src="<?php echo base_url('admin/assets/toko').'/' . esc($toko['logo_toko']); ?>"
                  ...
                  <div class="row">
                    <?php if($bulan):  ?>
                      ...
                      <table class="table table-sm" style="width:100%" id="supbul">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $bl['nama_pengirim_barang']; ?>
                            ...
                            <td class="text-center"><?php echo $qty = $bl['t_qty']; ?></td>

                            <td class="text-center"> <?php echo ($tanggal != date('Y-m')) ? '' : ''.$bl['stok_barang'] + $bl['t_qty'].''; ?></td>
                            <td class="text-center"><?php echo ($tanggal != date('Y-m')) ? '' : ''.$bl['stok_barang'].''; ?></td>
