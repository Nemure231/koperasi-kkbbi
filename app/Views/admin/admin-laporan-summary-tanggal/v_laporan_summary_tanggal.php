      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <?php echo form_open(base_url().'/laporan/summary_tanggal', $form_tanggal);    ?>
              <div class="row">
                <div class="col-lg-6 mb-3">
                  <div class="alert alert-primary alert-has-icon">
                    ...
                    <div class="alert-body">
                      ...
                      Anda juga dapat melakukan pencarian pada tanggal yang telah lewat menggunakan form
                      pencarian.
                    </div>
                  </div>
              ...
              <div class="row" id="area-1">
                ...
                <div class="col-lg-12">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <h3 class="text-center">Laporan Barang Summary Tanggal</h3>
                      ...
                      <div class="table-responsive">
                        <table class="table table-sm table-bordered">
                          ...
                          <tr>
                            ...
                            <tr>
                              <th style="border: 1px solid black;" class="text-center" scope="col">#</th>
                              <th style="border: 1px solid black;" scope="col">Tanggal </th>
                          ...
                          <tbody>
                            <?php  $i =1;?>
                            <?php foreach($tanggal_masuk as $m):?>
                            <tr>
                              <th style="border: 1px solid black;" class="text-center" scope="row"><?php echo $i; ?></th>

                              <td style="border: 1px solid black;"><?php echo $m['nama_tanggal']; ?></td>
                    ...
                    <div class="col-6">
                      <div class="table-responsive">
                        <table class="table table-sm table-bordered">
                          ...
                          <tbody>
                            <?php  $i =1;?>
                            <?php foreach($tanggal_keluar as $m):?>
                            <tr>
                              <th style="border: 1px solid black;" class="text-center" scope="row"><?php echo $i; ?></th>
