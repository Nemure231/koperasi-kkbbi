                ...
                <img src="<?php echo base_url('admin/assets/toko').'/' . esc($toko['logo_toko']); ?>"
                  ...
                  <div class="row">
                    <?php if($hari):  ?>
                      ...
                      <table class="table table-sm" style="width:100%" id="suphar">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $thh['nama_pengirim_barang']; ?>
                            ...
                            <td class="text-center"><?php echo $qty = $thh['t_qty']; ?></td>
                            <td class="text-center"> <?php echo ($tanggal_ini != date('Y-m-d')) ? '' : ''.$thh['stok_barang'] + $thh['t_qty'].''; ?></td>
                            <td class="text-center"><?php echo ($tanggal_ini != date('Y-m-d')) ? '' : ''.$thh['stok_barang'].''; ?></td>
