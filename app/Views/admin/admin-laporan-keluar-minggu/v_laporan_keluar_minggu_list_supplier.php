      ...
      <div class="col-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <?php echo form_open(base_url().'/keluar/barangkeluarminggu', $form_minggu);    ?>
              <?php echo csrf_field(); ?>
              <div class="row">
                ...
                <img src="<?php echo base_url('admin/assets/toko').'/' . esc($toko['logo_toko']); ?>"
                  ...
                  <div class="row">
                    <?php if($minggu):  ?>
                      ...
                      <table class="table table-sm" style="width:100%" id="supming">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                            <?php echo $mi['nama_pengirim_barang']; ?></div>
